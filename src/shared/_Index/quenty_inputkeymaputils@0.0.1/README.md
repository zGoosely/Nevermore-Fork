...
```luau
--!strict
local InputKeyMapService = require("@game/ReplicatedStorage/Packages/InputKeyMapService")
...
```luau
--!strict
local InputKeyMapServiceClient = require("@game/ReplicatedStorage/Packages/InputKeyMapServiceClient")
local ServiceBag = require("@game/ReplicatedStorage/Packages/ServiceBag")
...
local InputKeyMap = require("@game/ReplicatedStorage/Packages/InputKeyMap")
local InputKeyMapList = require("@game/ReplicatedStorage/Packages/InputKeyMapList")
local InputKeyMapListProvider = require("@game/ReplicatedStorage/Packages/InputKeyMapListProvider")
local InputModeTypes = require("@game/ReplicatedStorage/Packages/InputModeTypes")
local SlottedTouchButtonUtils = require("@game/ReplicatedStorage/Packages/SlottedTouchButtonUtils")
...
```luau
local GeneralInputKeyMapProvider = require("@game/ReplicatedStorage/Packages/GeneralInputKeyMapProvider")
...
```luau
--!strict
local InputKeyMapListUtils = require("@game/ReplicatedStorage/Packages/InputKeyMapListUtils")
...
```luau
local InputImageLibrary = require("@game/ReplicatedStorage/Packages/InputImageLibrary")
...
local GeneralInputKeyMapProvider =
	require("@game/ReplicatedStorage/Packages/GeneralInputKeyMapProvider")

local InputHint = require("@game/ReplicatedStorage/Packages/InputHint")
...
local ProximityPromptInputUtils =
	require("@game/ReplicatedStorage/Packages/ProximityPromptInputUtils")
...
local InputKeyMapListUtils =
	require("@game/ReplicatedStorage/Packages/InputKeyMapListUtils")
local ProximityPromptInputUtils =
	require("@game/ReplicatedStorage/Packages/ProximityPromptInputUtils")
