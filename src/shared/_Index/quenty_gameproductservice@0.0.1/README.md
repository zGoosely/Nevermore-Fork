...
```luau
-- Server
serviceBag:GetService(require("@game/ServerStorage/ServerPackages/GameProductService"))
...
```luau
local PlayerDataStoreService = serviceBag:GetService(require("@game/ServerStorage/ServerPackages/PlayerDataStoreService"))
local GameProductService = serviceBag:GetService(require("@game/ServerStorage/ServerPackages/GameProductService"))
