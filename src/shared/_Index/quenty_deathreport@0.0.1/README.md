...
```luau
-- Server Script
const DeathReportService = require("@game/ServerStorage/ServerPackages/DeathReportService")
const PlayerKillTrackerAssigner = require("@game/ReplicatedStorage/Packages/PlayerKillTrackerAssigner")
...
```luau
-- Client LocalScript
const DeathReportServiceClient = require("@game/ReplicatedStorage/Packages/DeathReportServiceClient")
const DeathReportUtils = require("@game/ReplicatedStorage/Packages/DeathReportUtils")
const ServiceBag = require("@game/ReplicatedStorage/Packages/ServiceBag")
