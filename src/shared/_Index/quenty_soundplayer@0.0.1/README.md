...
const SoundPlayerService = require("@game/ServerStorage/ServerPackages/SoundPlayerService")
...
```luau
const ServiceBag = require("@game/ReplicatedStorage/Packages/ServiceBag")
const SoundPlayerServiceClient = require("@game/ReplicatedStorage/Packages/SoundPlayerServiceClient")
...
const LoopedSoundPlayer = require("@game/ReplicatedStorage/Packages/LoopedSoundPlayer")
...
```luau
const SoundEffectService = require("@game/ReplicatedStorage/Packages/SoundEffectService")
const WellKnownSoundGroups = require("@game/ReplicatedStorage/Packages/WellKnownSoundGroups")
...
const LayeredLoopedSoundPlayer = require("@game/ReplicatedStorage/Packages/LayeredLoopedSoundPlayer")
...
```luau
const SimpleLoopedSoundPlayer = require("@game/ReplicatedStorage/Packages/SimpleLoopedSoundPlayer")
