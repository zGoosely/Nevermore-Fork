...
```luau
const HighlightServiceClient = require("@game/ReplicatedStorage/Packages/HighlightServiceClient")
...
```luau
const AnimatedHighlight = require("@game/ReplicatedStorage/Packages/AnimatedHighlight")
