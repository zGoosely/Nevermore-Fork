...
```luau
const RoguePropertyService = require("@game/ReplicatedStorage/Packages/RoguePropertyService")
...
-- CharacterStats.luau
--!strict
const RoguePropertyTableDefinition = require("@game/ReplicatedStorage/Packages/RoguePropertyTableDefinition")
...
```luau
const CharacterStats = require("@game/ReplicatedStorage/Packages/CharacterStats")
...
```luau
const RoguePropertyModifierData = require("@game/ReplicatedStorage/Packages/RoguePropertyModifierData")
