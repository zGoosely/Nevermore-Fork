...
```luau
local playerIds = serviceBag:GetService(require("@game/ServerStorage/ServerPackages/PlayerIdService"))
...
local PlayerIdServiceInterface = require("@game/ReplicatedStorage/Packages/PlayerIdServiceInterface")
