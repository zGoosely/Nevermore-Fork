...
```luau
const GameConfigService = require("@game/ServerStorage/ServerPackages/GameConfigService")
...
-- Client
const GameConfigServiceClient = require("@game/ReplicatedStorage/Packages/GameConfigServiceClient")
...
const RxStateStackUtils = require("@game/ReplicatedStorage/Packages/RxStateStackUtils")
...
```luau
const MantleConfigProvider = require("@game/ReplicatedStorage/Packages/MantleConfigProvider")
