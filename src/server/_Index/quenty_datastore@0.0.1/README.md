...
```luau
--!strict
const GameDataStoreService = require("@game/ServerStorage/ServerPackages/GameDataStoreService")
...
const DataStore = require("@game/ServerStorage/ServerPackages/DataStore")
