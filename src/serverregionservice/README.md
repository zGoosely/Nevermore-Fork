...
```luau
const serverRegionService = serviceBag:GetService(require("ServerRegionService"))
...
```luau
const serverRegionServiceClient = serviceBag:GetService(require("ServerRegionServiceClient"))
