...
```luau
-- Server
serviceBag:GetService(require("InputKeyMapDataStoreService"))

-- Client
serviceBag:GetService(require("InputKeyMapDataStoreServiceClient"))
```
