...
```lua
--!strict
const TemplateProvider = require("@game/ReplicatedStorage/Packages/TemplateProvider")
...
```lua
-- Server service
const VehicleTemplateProvider = require("@game/ReplicatedStorage/Packages/VehicleTemplateProvider")
...
```lua
const TaggedTemplateProvider = require("@game/ReplicatedStorage/Packages/TaggedTemplateProvider")
