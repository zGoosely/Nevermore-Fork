...
```luau
const FakeSkybox = require("@game/ReplicatedStorage/Packages/FakeSkybox")
...
```luau
const FakeSkyboxRenderMethod = require("@game/ReplicatedStorage/Packages/FakeSkyboxRenderMethod")
