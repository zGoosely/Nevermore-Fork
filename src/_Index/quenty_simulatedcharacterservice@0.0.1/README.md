...
```luau
const SimulatedCharacterService = require("@game/ReplicatedStorage/Packages/SimulatedCharacterService")
const SimulatedCharacterEnums = require("@game/ReplicatedStorage/Packages/SimulatedCharacterEnums")
...
```luau
const SimulatedCharacterMovementController = require("@game/ReplicatedStorage/Packages/SimulatedCharacterMovementController")
...
```luau
const SimulatedCharacterServiceClient = require("@game/ReplicatedStorage/Packages/SimulatedCharacterServiceClient")
