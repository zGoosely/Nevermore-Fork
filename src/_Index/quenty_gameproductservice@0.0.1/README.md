...
```luau
const GameProductDataService = require("@game/ReplicatedStorage/Packages/GameProductDataService")
...
```luau
-- Server
serviceBag:GetService(require("@game/ReplicatedStorage/Packages/GameProductService"))

-- Client
serviceBag:GetService(require("@game/ReplicatedStorage/Packages/GameProductServiceClient"))
```
...
```luau
local GameConfigService = serviceBag:GetService(require("@game/ReplicatedStorage/Packages/GameConfigService"))
...
```luau
local PlayerDataStoreService = serviceBag:GetService(require("@game/ReplicatedStorage/Packages/PlayerDataStoreService"))
local GameProductService = serviceBag:GetService(require("@game/ReplicatedStorage/Packages/GameProductService"))
...
```luau
local GameProductHandlerResult = require("@game/ReplicatedStorage/Packages/GameProductHandlerResult")
...
```luau
local GameProductServiceClient = serviceBag:GetService(require("@game/ReplicatedStorage/Packages/GameProductServiceClient"))
