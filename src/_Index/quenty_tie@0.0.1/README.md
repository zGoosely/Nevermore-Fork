...
--!strict
const TieDefinition = require("@game/ReplicatedStorage/Packages/TieDefinition")
...
```luau
const HealthInterface = require("@game/ReplicatedStorage/Packages/HealthInterface")
