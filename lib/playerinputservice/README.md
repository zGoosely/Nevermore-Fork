...
const PlayerInputActionProvider = require("PlayerInputActionProvider")
...
```luau
-- Server
const GeneralInputActions = require("GeneralInputActions")
...
```luau
-- Client
const PlayerInputCooldownServiceClient = require("PlayerInputCooldownServiceClient")
